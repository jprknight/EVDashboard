...
%>
<!-- Main Form -->
<form id="frmconfig" method="post" action="EnabledMailboxesLite.asp">
<!-- Table for page heading -->
<table width="100%" class="Main">
<tr>
<td>
<h1><img src="images/users.png"> Enabled Mailboxes Lite</h1>
</td>
<td align="right">
...
<a href="EnabledMailboxesLiteExport.asp" title="Download data as Excel Spreadsheet"><img border="0" src="images/page_excel.png"> Download</a>
<br><br>
...
<script language="javascript" type="text/javascript">  
	...
	var table1_Props =  {
		...
		sort: true,
		sort_config: {
			sort_types:['String','String','Number','Number','Number','Number','String','String']
		},	
