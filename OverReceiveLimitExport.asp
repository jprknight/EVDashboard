...
<tr>
	...
	<td BGCOLOR="#C0C0C0">Over Receive (MB)</td>
...
strSQLQuery1 = "Select Mailbox,OverReceiveMB,WarningMB,SendMB,ReceiveMB," & _
	"MailboxSizeMB,NumItemsMailbox,ExchangeServer,LastArchived,ExchangeState,PolicyUsed from OverReceiveLimit " & _
...
While not result1.EOF		
	Response.Write("<tr><td>" & (result1("Mailbox")) & "</td><td>" & (result1("OverReceiveMB")) & _
