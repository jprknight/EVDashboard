...
<%
' EXPORT USED WHEN GENERATE LIVE DATA OPTION IS SELECTED IN CONFIGURE EV DASHBOARD PAGE.
Styr = Year(Now)
Stmo = Month(Now)
if Stmo < 10 Then
	Stmo = "0" & Stmo
...
Response.AddHeader "Content-Disposition", "attachment; filename=EV-OverSendLimit-" & DateTime & ".xls"
%>
<CENTER>
...
strSQLQuery1 = "Select Mailbox,OverSendMB,WarningMB,SendMB,ReceiveMB," & _
	"MailboxSizeMB,NumItemsMailbox,ExchangeServer,LastArchived,ExchangeState,PolicyUsed from OverSendLimit " & _
...
While not result1.EOF		
	Response.Write("<tr><td>" & (result1("Mailbox")) & "</td><td>" & (result1("OverSendMB")) & _
