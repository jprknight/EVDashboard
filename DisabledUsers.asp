...
%>
<!-- Main Form -->
<form id="frmconfig" method="post" action="DisabledUsers.asp">
<!-- Table for page heading -->
<table width="100%" class="Main">
<tr>
<td>
<h1><img src="images/users.png"> Disabled Users</h1>
</td>
<td align="right">
...
<a href="DisabledUsersExport.asp" title="Download data as Excel Spreadsheet"><img border="0" src="images/page_excel.png"> Download</a>
<br><br>
...
strSQLQuery1 = "Select Mailbox,WarningMB,SendMB,ReceiveMB,MailboxSizeMB," & _
	"NumItemsMailbox From DisabledUsers " & SQLWhereClause
...
While not result1.EOF
	Response.Write ("<tr><td>" & (result1("Mailbox")) & _
		...
		"</td><td>" & (result1("NumItemsMailbox")) & "</td></tr>")
	result1.movenext()
Wend
...
<script language="javascript" type="text/javascript">  
	...
	var table1_Props =  {
		...
		sort: true,
		sort_config: {
			sort_types:['String','Number','Number','Number','Number','Number','Number']
		},	
