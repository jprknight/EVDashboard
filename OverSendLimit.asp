...
%>
<!-- Main Form -->
<form id="frmconfig" method="post" action="OverSendLimit.asp">
<!-- Table for page heading -->
<table width="100%" class="Main">
<tr>
<td>
<h1><img src="images/users.png"> Users Over Send Limit</h1>
</td>
<td align="right">
...
<a href="OverSendLimitExport.asp" title="Download data as Excel Spreadsheet"><img border="0" src="images/page_excel.png"> Download</a>
<br><br>
...
<thead>
	<tr>
		...
		<th nowrap align="left">Over Send (MB)</th>
...
strSQLQuery1 = "Select Mailbox,ExchangeServer,OverSendMB,WarningMB,SendMB,ReceiveMB," & _
	"MailboxSizeMB,NumItemsMailbox,LastArchived from OverSendLimit " & _
	SQLWhereClause
...
<script language="javascript" type="text/javascript">  
	...
	var table1_Props =  {
		...
		sort: true,
		sort_config: {
			sort_types:['String','String','Number','Number','Number','Number','Number','String','String']
		},	
		col_1: "select",    
