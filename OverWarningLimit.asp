...
%>
<!-- Main Form -->
<form id="frmconfig" method="post" action="OverWarningLimit.asp">
<!-- Table for page heading -->
<table width="100%" class="Main">
<tr>
<td>
<h1><img src="images/users.png"> Users Over Warning Limit</h1>
</td>
<td align="right">
...
<a href="OverWarningLimitExport.asp" title="Download data as Excel Spreadsheet"><img border="0" src="images/page_excel.png"> Download</a>
<br><br>
...
<tr>
	...
	<th nowrap align="left">Over Warning (MB)</th>
...
strSQLQuery1 = "Select Mailbox,ExchangeServer,OverWarningMB,WarningMB,SendMB,ReceiveMB," & _
	"MailboxSizeMB,NumItemsMailbox,LastArchived from OverWarningLimit " & _
	SQLWhereClause & _
	"Order By Mailbox"
...
<script language="javascript" type="text/javascript">  
	...
	var table1_Props =  {
		...
		sort: true,
		sort_config: {
			sort_types:['String','String','Number','Number','Number','Number','Number','Number','String']
		},
		col_1: "select",    
		...
		alternate_rows: true,
		loader: true,
		loader_html: '<img src="./images/loader.gif" alt="" style="vertical-align:middle; margin-right:5px;" />Loading...',
		status_bar: true,
		enter_key: false,
